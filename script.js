/* ============================================================
   DEO FITNESS GYM — Premium JavaScript
   ============================================================ */
...
window.addEventListener('load', () => {
  setTimeout(() => {
    ...
    setTimeout(() => {
      const texts = [
        { el: 'tw1', text: 'Welcome To DEO FITNESS GYM', speed: 30 },
        { el: 'tw2', text: 'Jahan Fitness Sirf Goal Nahi Lifestyle Hai', speed: 18 },
        { el: 'tw3', text: 'Founder & Head Coach', speed: 25 },
        { el: 'tw4', text: 'Mr. Mukesh Singh', speed: 32 },
        { el: 'tw5', text: 'Transform Your Body. Transform Your Life.', speed: 20 },
      ];
...
if (submitForm) {
  submitForm.addEventListener('click', () => {
    ...
    const message = encodeURIComponent(
      `🏋️ *DEO FITNESS GYM — New Membership Request* 🏋️\n\n` +
      `👤 Name: ${name.value}\n` +
      `⚤ Gender: ${gender.value}\n` +
      `🎂 Age: ${age.value}\n` +
      `📞 Mobile: ${mobile.value}\n` +
    ...
    if (successText) {
      successText.textContent = `You are now a DEO FITNESS GYM ${selectedPlan} Member. Our team will contact you shortly.`;
    }
...
if (calcBMI) {
  calcBMI.addEventListener('click', () => {
    ...
    if (bmi < 18.5) {
      label = 'Underweight';
      suggestion = 'Your BMI suggests you may need to build more body mass and strength. Join DEO FITNESS GYM to build muscle, improve strength, and achieve a healthy body composition under expert guidance.';
      ringColor = '#64B5F6';
    } else if (bmi < 25) {
      label = 'Normal';
      suggestion = 'Great work — your BMI is in the healthy range! Join DEO FITNESS GYM to achieve peak fitness, build lean muscle, and maintain your results long-term with our certified trainers.';
      ringColor = '#81C784';
    } else if (bmi < 30) {
      label = 'Overweight';
      suggestion = 'Your BMI suggests you are in the overweight range. Join DEO FITNESS GYM to transform your physique with personalized training programs, structured cardio sessions, and expert dietary guidance.';
      ringColor = '#FFD54F';
    } else {
      label = 'Obese';
      suggestion = 'Your BMI indicates obesity. The good news — consistent training creates incredible transformations. Join DEO FITNESS GYM today and let our expert coaches guide you safely and effectively toward your ideal body.';
      ringColor = '#E57373';
    }
...
console.log('%cDEO FITNESS GYM — Premium Website Loaded ✅', 'color: #FFD700; font-size: 14px; font-weight: bold;');
